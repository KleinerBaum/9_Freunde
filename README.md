...
- **Dashboard mit integrierter Admin-Übersicht:** Die Kinder-Übersicht für Admins wird direkt im Bereich **Dashboard / Dashboard** angezeigt; darunter ist jetzt die eingebettete Kalenderansicht verfügbar.
- **Dashboard mit Terminvorschau:** **"Bevorstehende Termine / Upcoming events"** wird im Admin-Dashboard unter der **Admin-Übersicht / Admin overview** angezeigt; direkt darunter folgt die Kalender-Einbettung.
- **Kalenderintegration:** Verwaltung wichtiger Termine über Google Calendar (inkl. Anzeige für Eltern) mit `services/calendar_service.py` (`add_event`, `list_events`, 60s Cache); die IFrame-Kalenderansicht ist im Admin-Dashboard verortet, der Kalenderbereich fokussiert auf die Terminerstellung.
