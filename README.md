...
- **Dashboard mit integrierter Admin-Übersicht:** Die Kinder-Übersicht für Admins wird direkt im Bereich **Dashboard / Dashboard** angezeigt; der Hinweistext wurde durch eine Dashboard-Kurzbeschreibung ersetzt.
- **Dashboard mit Terminvorschau:** **"Bevorstehende Termine / Upcoming events"** wird im Admin-Dashboard unter der **Admin-Übersicht / Admin overview** angezeigt; im Kalender-Bereich bleibt die Erstellung neuer Termine bestehen.
